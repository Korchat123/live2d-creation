...
| P0-A | Character bible geometry and rejection fixtures | Recreation builder | `feat/p0-anime-geometry-spec` | PLAN-001 PASS | Gate A | recreating | Failed candidates `129aa86`, `e5441c5`, `e1fa52e` | Gate 3 FAIL: `review/p0-anime-geometry-gate-3` at `0472e00`; ears pass, but the acromion cusp and floating/zero-bust chest field remain rejected | - |
