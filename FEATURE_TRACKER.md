...
|---|---|---|---|---|---|---|---|---|---|
| PLAN-001 | Clean restart and governance baseline | Root coordinator | `plan/clean-restart-governance` | - | Documentation | failed | `4263c82` | Gate 1 FAIL: `review/plan-001-gate-1` at `576075a` | - |
| P0-A | Character bible and measurable proportions | Art director | `plan/clean-restart-governance` | PLAN-001 remediation | Gate A | evaluating | pending remediation candidate | Gate 2 must pass before M0 | - |
