export const STANDARD_BUST_SPEC = Object.freeze({
  ...
  parameters: Object.freeze({
    ...
    upperNeckHeadRatio: { label: "Upper neck / head", min: 0.31, max: 0.40, step: 0.01, value: 0.34 },
    ...
    shoulderDrop: { label: "Shoulder-root to acromion drop", min: 44, max: 60, step: 1, value: 52 },
    ...
    chinCraniumRatio: { label: "Chin shelf / cranium", min: 0.31, max: 0.40, step: 0.01, value: 0.34 },
    eyeCenterFaceRatio: { label: "Eye centers / face-at-eye", min: 0.47, max: 0.53, step: 0.001, value: 0.516 },
    eyeWidth: { label: "Eye width", min: 59, max: 69, step: 1, value: 62 },
    eyeHeight: { label: "Eye height", min: 27, max: 36, step: 1, value: 31 },
    ...
    mouthWidth: { label: "Closed mouth width", min: 30, max: 55, step: 1, value: 42 },
    mouthHeight: { label: "Closed mouth height", min: 2, max: 10, step: 1, value: 4 },
    mouthChinShare: { label: "Mouth-to-chin / eye-to-chin", min: 0.31, max: 0.42, step: 0.01, value: 0.36 },
  ...
  ratioRanges: Object.freeze({
    shoulderHead: [2.05, 2.48], headAspect: [1.16, 1.31], jawCranium: [0.67, 0.75], upperNeckHead: [0.31, 0.40],
    collarHead: [0.38, 0.49], upperNeckJaw: [0.42, 0.62], neckLengthHead: [0.22, 0.34], templeCranium: [0.94, 1.00],
    cheekCranium: [0.86, 0.94], chinCranium: [0.31, 0.40], eyeCenterFace: [0.47, 0.53], eyeAspect: [1.70, 2.35],
    innerGapEye: [0.88, 1.22], irisEye: [0.52, 0.72], eyeNose: [0.32, 0.45], noseMouth: [0.20, 0.32],
    mouthChin: [0.31, 0.42], mouthEyeCenters: [0.23, 0.43], hairHead: [1.12, 1.32], hairLiftHead: [0.06, 0.15],
    bustShoulder: [0, 0.64], bustApexShoulder: [0, 0.18], torso850Garment: [0.70, 0.78]
  }),
