...
| P0-A | Character bible geometry and rejection fixtures | Recreation builder | `feat/p0-anime-geometry-spec` | PLAN-001 PASS | Gate A | recreating | Failed candidate `129aa86` | Gate 1 FAIL: `review/p0-anime-geometry-gate-1` at `92e1421`; visible SVG contradicted declared metrics | - |
