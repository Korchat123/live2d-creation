...
| P0-A | Character bible geometry and rejection fixtures | Recreation builder | `feat/p0-anime-geometry-spec` | PLAN-001 PASS | Gate A | recreating | Failed candidates `129aa86`, `e5441c5` | Gate 2 FAIL: `review/p0-anime-geometry-gate-2` at `070c878`; ratios fixed, shoulder/chest/ear anatomy still rejected | - |
